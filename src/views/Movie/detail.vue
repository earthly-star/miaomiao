  ...
  <div id="detailContrainer" class="slide-enter-active">
    ...
    <div v-else id="content" class="contentDetail">
      ...
      <div class="detail_list">
				<div class="detail_list_bg" style="background-image: url(http://p0.meituan.net/148.208/movie/a3d6ca3bdd5b0ddd7016acff9a9f2f2e2805813.jpg)"></div>
				<div class="detail_list_filter"></div>
				<div class="detail_list_content">
					<div class="detail_list_img">
						<img src="http://p0.meituan.net/148.208/movie/a3d6ca3bdd5b0ddd7016acff9a9f2f2e2805813.jpg" alt="">
					</div>
      ...
      <div class="detail_player swiper-container" ref="detail_player">
				<ul class="swiper-wrapper">
					<li class="swiper-slide" v-for="(item,index) in 5" :key="index">
						<div>
							<img src="http://p0.meituan.net/140.127/movie/a3d6ca3bdd5b0ddd7016acff9a9f2f2e2805813.jpg" alt="">
						</div>
						<p>陈建斌</p>
						<p>马先勇</p>
					</li>
